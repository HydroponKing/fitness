...
export default function CoursePage() {
  return (
    <div className="font-Roboto max-w-[1200px] mx-auto">
      ...
      <div className="relative z-20 py-10 md:w-[1200px] w-[343px]  md:h-[300px] h-[377px] mt-[90px] md:mt-[102px]">
    ...
    src={manImage}
    alt="Man"
    className="w-[420px] block md:hidden mx-auto mt-4 translate-x-[100px] translate-y-[-620px] z-[-1]"
  />
    </div>
  )
}
