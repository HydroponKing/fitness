...
export default function CoursePage() {
  return (
    <div className="font-Roboto max-w-[1200px] mx-auto">
      ...
      <div className="py-10">
        <h2 className="text-[40px] font-semibold leading-[44px] text-left mb-6">
      ...
      {/* Направления */}
      <div className="py-8">
        <h2 className="text-[40px] font-semibold leading-[44px] text-left mb-6">Направления</h2>
      ...
      <div className="relative py-10 w-[1200px] h-[300px]">
        <div className="container mx-auto flex justify-between items-center bg-white shadow-2xl rounded-[20px] h-[490px]">
          <div>
            <h2 className="text-[60px] font-medium leading-[60px] text-left text-black w-[420px]">
              Начните путь к новому телу
            </h2>
            <ul className="mt-4 space-y-2 bg-gray-200 p-4 rounded list-disc list-inside">
              <li className="text-[24px] font-normal leading-[26.4px] text-left text-gray">
