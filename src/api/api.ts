...
export const getCourse = async (courseId: string) => { //Получает данные о конкретном курсе по его ID
  ...
  export const getVideo = async (workoutId: string) => { // для подучения "воркаутов с видео" в Firebase
